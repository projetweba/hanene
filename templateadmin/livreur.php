...
<h4 class="card-title">Tableau des Livreurs</h4>
</div>
<div class="table-overflow">
<table class="table table-hover table-lg">
<thead>
<tr>
<!--<td class="text-dark text-semibold">Delivery ID</td>-->
<td class="text-dark text-semibold">Name</td>
<td class="text-dark text-semibold">Email</td>
<td class="text-dark text-semibold">Phone Number</td>
...
foreach($liste as $row){
    ...
    <input type="hidden" value="<?PHP echo $row['nom_liv']; ?>" name="nom_liv">
    </form>
    <!--<td><a href="supprimerLivreur.php?nom_liv=<?PHP echo $row['nom_liv']; ?>">supprimer</a></td>-->
    </td>
    <td><a href="mod1.php?nom_liv=<?PHP echo $row['nom_liv']; ?>">modifier</a></td>
