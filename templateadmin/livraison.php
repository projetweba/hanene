...
<td class="text-dark text-semibold">DeliveryMan ID</td>
<td class="text-dark text-semibold">Order ID</td>
<td class="text-dark text-semibold">Adress</td>
<td class="text-dark text-semibold">City</td>
<td class="text-dark text-semibold">Postal Code</td>
...
foreach($listeLivraison as $row){
    ...
    <!--<td><a href="supprimerLivraison.php?nom_liv=<?PHP echo $row['id_livraison']; ?>">supprimer</a></td>-->
    </td>
